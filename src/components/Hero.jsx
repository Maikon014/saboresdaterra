...
const headphoneData = [
  {
    ...
    title: "Sabor Morning",
    subtitle:
      "É o momento para saborear a tranquilidade da manhã, refletir sobre os planos do dia e, acima de tudo, nutrir o corpo e a alma.",
    modal:"Pepito",
    bgColor: "#6495ED",
  },
  {
    id: 2,
    image: Fanta2,
    title: "Sabor Afternoon",
    subtitle:
      "É a oportunidade de compartilhar histórias, rir juntos e criar memórias enquanto se desfruta de uma comida que é feita com amor e dedicação.",
    modal: "Pepito",
    bgColor: "#DAA520",
  },
  {
    ...
    title: "Sabor Night",
    subtitle:
      "É um ritual de prazer e tranquilidade que transforma uma noite comum em algo verdadeiramente especial. E assim, ao fim da refeição, quando os pratos estão vazios e os corações estão cheios, a noite se estende com uma sensação de contentamento e serenidade.",
    modal: "Pepito",
    bgColor: "#727272",
  },
];
            ...
            <div className="space-y-5 text-center md:text-left">
              ...
              <AnimatePresence mode="wait">
                <motion.p
                  ...
                  animate="show"
                  exit="exit"
                  className="text-sm leading-loose text-white/95"
                >
                  {activeData.subtitle}
                </motion.p>
              </AnimatePresence>
              ...
              >
                ...
                <p className="uppercase text-sm ">Top Chef</p>
                <div className="w-20 h-[1px] bg-white"></div>
              </motion.div>
